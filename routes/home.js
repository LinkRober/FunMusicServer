...
router.get('/list',function(req,res,next){
	var music_1 = new MusicModel('1','1','Here With Me','describe title_1',
		'http://fun-music.oss-cn-beijing.aliyuncs.com/Here%20With%20Me.mp3',
		{'origin':'http://fun-image.oss-cn-beijing.aliyuncs.com/1.jpeg'},
		0,1,0,0,0);
